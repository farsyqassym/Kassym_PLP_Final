...
public class IdeaController {
    ...
    public ResponseEntity<?> acceptApplication(@PathVariable("id") Long ideaId ){
        Optional<Idea> applicationOptional = ideaRepository.findById(ideaId);
    ...
    public ResponseEntity<?> rejectApplication(@PathVariable("id") Long ideaId){
        Optional<Idea> applicationOptional = ideaRepository.findById(ideaId);
